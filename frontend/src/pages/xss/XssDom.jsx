...
import { contextIdByLab, getLabGoal, getPayloadItems, LAB_OPTIONS, MODE_OPTIONS } from './XssDom.config';
...
export default function XssDom() {
  ...
  const payloadItems = useMemo(() => getPayloadItems(lab), [lab]);

  const labGoal = useMemo(() => getLabGoal(lab), [lab]);
