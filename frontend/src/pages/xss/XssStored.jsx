...
import { FOCUS_HINT, FOCUS_OPTIONS, MODE_OPTIONS, PAYLOADS_BY_FOCUS, getWeakSummaryByFocus } from './XssStored.config';
...
export default function XssStored() {
  ...
  const weakSummary = useMemo(() => getWeakSummaryByFocus(focus), [focus]);
